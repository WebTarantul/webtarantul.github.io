...
$select_options = array(
	...
	'pink' => array(
		'value' =>	'pink',
		'label' => __( 'Розовый', 'pink' )
	),
	'purple' => array(
		'value' => 'purple',
		'label' => __( 'Фиолетовый', 'purple' )
	),
	'tomato' => array(
		'value' => 'tomato',
		'label' => __( 'Томатный', 'tomato' )
	)
);
			...
			<table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="sample_theme_options[adress]"><?php _e( 'Введите адрес', 'sampletheme' ); ?></label>
                    </td>
                </tr>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[phonenumber]"><?php _e( 'Введите телефон', 'sampletheme' ); ?></label>
					</td>
				</tr>
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Веб-сайт', 'sampletheme' ); ?></th>
                    <td>
                        ...
                        <label class="description" for="sample_theme_options[website]"><?php _e( 'Введите адрес веб-сайта', 'sampletheme' ); ?></label>
                    </td>
                </tr>
				...
				<tr valign="top"><th scope="row"><?php _e( 'Выберите цветовую схему', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[selectinput]"><?php _e( '', 'sampletheme' ); ?></label>
					</td>
				</tr>
